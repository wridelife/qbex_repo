...
Admin - <?php echo e(__('crud.admin.statements.provider')); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('heading'); ?>
<?php echo e(__('crud.admin.statements.provider')); ?>
        ...
        <table id="dataTable" class="w-full whitespace-no-wrap">
            <thead>
                <tr
                    ...
                    <th class="text-center px-4 py-3"><?php echo e(__('crud.admin.providers.name')); ?> <?php echo e(__('crud.inputs.name')); ?>

                    </th>
                    <th class="text-center px-4 py-3"><?php echo e(__('crud.admin.providers.name')); ?>
                    ...
                    <th class="text-center px-4 py-3"><?php echo e(__('crud.general.total')); ?> <?php echo e(__('crud.general.earning')); ?>
                ...
                <tr class="text-gray-700 dark:text-gray-400">
                        ...
                        <div class="flex items-center text-sm">
                            <div class="relative hidden w-8 h-8 mr-3 rounded-full md:block">
                                <img class="object-cover w-full h-full rounded-full"
                                    src="<?php echo e($provider->avatar ? asset('storage/'.$provider->avatar) : asset('img/avatar.png')); ?>"
                                    alt="" loading="lazy" />
                                <div class="absolute inset-0 rounded-full shadow-inner" aria-hidden="true"></div>
                            </div>
                            <div>
                                <p class="font-semibold text-gray-700 dark:text-gray-400"><?php echo e($provider->name); ?></p>
                            </div>
                        </div>
                    </td>
                    <td class="px-4 dark:text-gray-400 dark:bg-gray-800 py-3 text-sm text-center">
                    ...
                    <td class="px-4 dark:text-gray-400 dark:bg-gray-800 py-3 text-sm text-center">
                        <p class="font-semibold text-gray-700 dark:text-gray-400">
                            <?php echo e(currency($provider->payment->commission) ?? '-'); ?></p>
                    </td>
                    <td class="px-4 dark:text-gray-400 dark:bg-gray-800 py-3 text-sm text-center">
                        <p class="font-semibold text-gray-700 dark:text-gray-400"><?php echo e($provider->payment->jobs_count ?? '0'); ?></p>
                    </td>
                    <td class="px-4 dark:text-gray-400 dark:bg-gray-800 py-3 text-sm text-center">
                        <?php echo e($provider->created_at->diffForHumans()); ?>

                    </td>
                    <td class="px-4 dark:text-gray-400 dark:bg-gray-800 py-3 text-sm text-center">
                        <p class="font-semibold text-gray-700 dark:text-gray-400">
                            <?php echo e(currency($provider->payment->overall) ?? '-'); ?></p>
                    </td>
...
<?php $component->withAttributes(['link' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.statement.overall', ['provider', $provider->id]))]); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/cab/resources/views/admin/statement/provider.blade.php ENDPATH**/ ?>