<div class="w-full rounded-lg bg-white dark:text-gray-400 dark:bg-gray-800 mb-5">
    <div class="w-full px-5 py-5">
        <?php $__empty_1 = true; $__currentLoopData = $geoFences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        ...
        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('service-geo-fence', ['gf' => $gf,'serviceType' => $serviceType])->html();
    ...
    $response = \Livewire\Livewire::mount('service-geo-fence', ['gf' => $gf,'serviceType' => $serviceType]);
    $html = $response->html();
...
</div><?php /**PATH /var/www/cab/resources/views/admin/serviceType/serviceTypeGeoFencing.blade.php ENDPATH**/ ?>