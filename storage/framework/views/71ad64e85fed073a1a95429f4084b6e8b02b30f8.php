...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form','data' => ['action' => ''.e(route('admin.geoFencing.update', $geoFencing)).'','method' => 'put','hasFile' => true]]); ?>
<?php $component->withName('form'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['action' => ''.e(route('admin.geoFencing.update', $geoFencing)).'','method' => 'put','has-file' => true]); ?>
                <?php echo e(csrf_field()); ?>

                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.inputs.text','data' => ['space' => 'w-full','label' => __('crud.inputs.city_name'),'name' => 'city_name','value' => ''.e(old('city_name', $geoFencing->city_name)).'']]); ?>
<?php $component->withName('inputs.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['space' => 'w-full','label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('crud.inputs.city_name')),'name' => 'city_name','value' => ''.e(old('city_name', $geoFencing->city_name)).'']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                        <div id="map"></div>
                        <input type="hidden" name="ranges" class="ranges" value="<?php echo e(old('ranges', $geoFencing->ranges)); ?>">
                    </div>
                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/cab/resources/views/admin/geoFencing/edit.blade.php ENDPATH**/ ?>