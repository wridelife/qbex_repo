<tr class="text-gray-700 dark:text-gray-400">
    <td class="text-center dark:text-gray-400 dark:bg-gray-800 px-4 py-3"><?php echo e($index); ?></td>
    ...
    <td class="text-center">
        <input type="text" wire:model.defer="service_number" class="md:w-2/3 w-full appearance-none p-2 my-2 text-xs font-semibold leading-none rounded outline-none bg-gray-50 dark:bg-gray-700 dark:text-gray-300" placeholder="Enter <?php echo e(__('crud.inputs.number_plate')); ?>">
    </td>

    <td class="text-center">
        <input type="text" wire:model.defer="service_model" class="md:w-2/3 w-full appearance-none p-2 my-2 text-xs font-semibold leading-none rounded outline-none bg-gray-50 dark:bg-gray-700 dark:text-gray-300" placeholder="Enter <?php echo e(__('crud.inputs.model')); ?>">
    </td>
...
</tr><?php /**PATH /var/www/cab/resources/views/livewire/provider-single-service.blade.php ENDPATH**/ ?>