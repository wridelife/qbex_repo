...
Admin - <?php echo e(__('crud.admin.statements.user')); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('heading'); ?>
<?php echo e(__('crud.admin.statements.user')); ?>
        ...
        <table id="dataTable" class="w-full whitespace-no-wrap">
            <thead>
                <tr
                    ...
                    <th class="text-center px-4 py-3"><?php echo e(__('crud.admin.users.name')); ?> <?php echo e(__('crud.inputs.name')); ?>

                    </th>
                    <th class="text-center px-4 py-3"><?php echo e(__('crud.inputs.phone')); ?></th>
                    <th class="text-center px-4 py-3"><?php echo e(__('crud.general.total')); ?> <?php echo e(__('crud.general.jobs')); ?>

                        <?php echo e(__('crud.general.posted')); ?></th>
                    <th class="text-center px-4 py-3"><?php echo e(__('crud.general.member_since')); ?></th>
                    <th class="text-center px-4 py-3"><?php echo e(__('crud.general.total')); ?> <?php echo e(__('crud.general.spent')); ?></th>
            ...
            <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                ...
                <tr class="text-gray-700 dark:text-gray-400">
                        ...
                        <div class="flex items-center text-sm">
                            <div class="relative hidden w-8 h-8 mr-3 rounded-full md:block">
                                <img class="object-cover w-full h-full rounded-full"
                                    src="<?php echo e($user->avatar ? asset('storage/'.$user->avatar) : asset('img/avatar.png')); ?>"
                                    alt="" loading="lazy" />
                    ...
                    <td class="px-4 dark:text-gray-400 dark:bg-gray-800 py-3 text-sm text-center">
                        <p class="font-semibold text-gray-700 dark:text-gray-400"><?php echo e($user->mobile ?? '-'); ?></p>
                    </td>
                    <td class="px-4 dark:text-gray-400 dark:bg-gray-800 py-3 text-sm text-center">
                        <p class="font-semibold text-gray-700 dark:text-gray-400">
                            <?php echo e($user->payment[0]->jobs_posted ?? '0'); ?></p>
                    </td>
                    <td class="px-4 dark:text-gray-400 dark:bg-gray-800 py-3 text-sm text-center">
                    ...
                    <td class="px-4 dark:text-gray-400 dark:bg-gray-800 py-3 text-sm text-center">
                        <p class="font-semibold text-gray-700 dark:text-gray-400">
                            <?php echo e(currency($user->payment[0]->overall) ?? '-'); ?></p>
                    </td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/cab/resources/views/admin/statement/user.blade.php ENDPATH**/ ?>