<?php $__env->startSection('title'); ?>
    Admin - Dispatcher <?php echo e(__('crud.navlinks.dashboard')); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('heading'); ?>
    Dispatcher <?php echo e(__('crud.navlinks.dashboard')); ?>
...
<?php $__env->startSection('content'); ?>
    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('dispatcher-dashboard', [
        'active' => request()->has('active') ? request()->active : NULL
    ])->html();
} elseif ($_instance->childHasBeenRendered('NofuGdl')) {
    $componentId = $_instance->getRenderedChildComponentId('NofuGdl');
    $componentTag = $_instance->getRenderedChildComponentTagName('NofuGdl');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('NofuGdl');
} else {
    $response = \Livewire\Livewire::mount('dispatcher-dashboard', [
        'active' => request()->has('active') ? request()->active : NULL
    ]);
    $html = $response->html();
    $_instance->logRenderedChild('NofuGdl', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/cab/resources/views/admin/dispatcher_dashboard.blade.php ENDPATH**/ ?>