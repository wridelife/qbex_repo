...
@section('title')
    Admin - {{ __('crud.admin.cancelReasons.update') }}
@endsection

@section('heading')
    {{ __('crud.admin.cancelReasons.update') }}
@endsection

@section('content')
    <div class="w-full rounded-lg shadow-xs bg-white dark:text-gray-400 dark:bg-gray-800 mb-5">
        <div class="w-full px-5 py-5">
            <x-form action="{{ route('admin.cancelReason.update', $cancelReason) }}" method="put" has-file>
